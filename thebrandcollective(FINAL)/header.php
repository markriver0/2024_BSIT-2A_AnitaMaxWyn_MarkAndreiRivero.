...
<head>
  ...
  <style>
    ...
    * {
    ...
    .cart:hover, .order:hover, .logout:hover {
      scale: 1.30;
      fill: #B02E0C;
    }
...
<body>
  <header>
    <img class="logo" src="1.png" alt="logo" style="height: 12%; width: 12%;">
    <nav>
      <ul class="navbar">
        ...
        <li><a href="aboutus.php" class="<?php echo isset($activePage) && $activePage == 'aboutus' ? 'active' : ''; ?>">About Us</a></li>

        <form method="GET" action="search_function.php" style="display:inline;">
          <input class="search" type="text" placeholder="Search" name="searchbar">
        </form>
        ...
        <a href="my_orders.php"><svg xmlns="http://www.w3.org/2000/svg" class="order" stroke="#2d2c2c" stroke-width="1.0" width="1.8rem" height="1.8rem" viewBox="0 0 24 24"><path fill="" d="M4 18V7.1L2.45 3.75q-.175-.375-.025-.763t.525-.562t.763-.037t.562.512L6.2 7.05h11.6l1.925-4.15q.175-.375.563-.525t.762.05q.375.175.525.563t-.025.762L20 7.1V18q0 .825-.587 1.413T18 20H6q-.825 0-1.412-.587T4 18m6-5h4q.425 0 .713-.288T15 12t-.288-.712T14 11h-4q-.425 0-.712.288T9 12t.288.713T10 13"/></svg></a>

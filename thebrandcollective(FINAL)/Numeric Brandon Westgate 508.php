...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://nb.scene7.com/is/image/NB/nm508ony_nb_07_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper2" style="background-image: url(https://nb.scene7.com/is/image/NB/nm508ony_nb_05_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper3" style="background-image: url(https://nb.scene7.com/is/image/NB/nm508ony_nb_06_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper4" style="background-image: url(https://nb.scene7.com/is/image/NB/nm508ony_nb_04_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
        </div>
        ...
        <input type="hidden" name="product" value="Numeric Brandon Westgate 508" >  <p style="font-size: 24px; font-weight: 600;" >Numeric Brandon Westgate 508</p>

      <input type="hidden" name="price" value="4900" >    <p style="font-size: 24px; font-weight: 600;" name="price" value="₱4,900">₱4,900</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 7";

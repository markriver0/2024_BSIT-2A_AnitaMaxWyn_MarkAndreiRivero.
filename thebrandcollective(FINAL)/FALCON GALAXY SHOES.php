...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/4f47b345310e44229cd2a14d6d0fb265_9366/Falcon_Galaxy_Shoes_Blue_IG5680_41_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/acb42bf6d930467d9f83ec46b529c849_9366/Falcon_Galaxy_Shoes_Blue_IG5680_04_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7b8f8197a3c54e2988b9f5b62756dead_9366/Falcon_Galaxy_Shoes_Blue_IG5680_05_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/89f450a9c80c4334993e8c17cdfdcf92_9366/Falcon_Galaxy_Shoes_Blue_IG5680_42_detail.jpg);"></div>
        </div>
     ...
     <input type="hidden"  name="product" value="FALCON GALAXY SHOES"><p style="font-size: 24px; font-weight: 600;">FALCON GALAXY SHOES</p>

     <input type="hidden"name="price" value="5500"><p style="font-size: 24px; font-weight: 600;">₱5,500</p>
        </div>
        <p>Women's Shoe</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 23";

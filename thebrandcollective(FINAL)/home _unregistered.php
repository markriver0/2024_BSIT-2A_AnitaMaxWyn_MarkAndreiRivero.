...
<head>
  ...
  <link rel="stylesheet" href="home_unregistered.css">
...
<header>
  ...
  <nav>
    <ul class= "navbar">
      ...
      <li><a href="./signup/signup.php" style="margin-left: 50px; color: #E19191;">Create an account</a></li>
...
<div class="body1 section">
  <div class="container">
    <div class="body1grid1">
      ...
      <form action="">
      <a href="./signup/signup.php">  <button class="animation">Explore Now</button> </a>
      </form>
    </div>
...
<div class="grid5">
  ...
  <div class="text2">
    ...
    <a href="Nike Dunk Retro.php"> <button>Get now</button> </a>
  </div>
</div>
...
<div class="grid6">
  ...
  <div class="text2">
   ...
   <a href="Nike Zoom Vomero 5.php"> <button>Get now</button> </a>
  </div>
</div>
...
<div class="grid7">
  ...
  <div class="text2">
   ...
   <a href="Nike Air Max 90.php "> <button>Get now</button> </a>
  </div>
</div>

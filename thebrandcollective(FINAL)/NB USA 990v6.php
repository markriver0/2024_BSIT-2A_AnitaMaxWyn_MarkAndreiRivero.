...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://nb.scene7.com/is/image/NB/u990tn6_nb_07_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper2" style="background-image: url(https://nb.scene7.com/is/image/NB/u990tn6_nb_05_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper3" style="background-image: url(https://nb.scene7.com/is/image/NB/u990tn6_nb_06_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper4" style="background-image: url(https://nb.scene7.com/is/image/NB/u990tn6_nb_08_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
        </div>
        ...
        <form action="add_to_cart_process.php" method="post">
          ...
          <div class="flex">
      <input type="hidden" name="product" value="NB USA 990v6">  <p style="font-size: 24px; font-weight: 600;">NB USA 990v6</p>

        <input type="hidden" name="price" value="11455">  <p style="font-size: 24px; font-weight: 600;">₱11,455</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 8";
        ...
        <div class="sizewrapper">
          ...
          <div class="size12">
            <input type="radio" name="size" id="US12.5" value="12.5" required>
            <label for="US12.5">US12.5</label>
          </div>

          <!-- <input type="hidden" name="amount" id="amount" value="11455"> -->

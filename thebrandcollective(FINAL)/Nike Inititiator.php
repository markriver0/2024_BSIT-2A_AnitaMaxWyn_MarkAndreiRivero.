...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/16cbf009-3807-48d6-8872-4f6fe2f1460c/initiator-shoes-4wMBsb.png);"></div>
    
          <div class="wrapper2" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/23a7fd79-c8bf-423a-ae51-8fbb74e25fc4/initiator-shoes-4wMBsb.png);"></div>
    
          <div class="wrapper3" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/0ff90cf2-28ff-4913-ab56-39994a33dcf1/initiator-shoes-4wMBsb.png);"></div>
    
          <div class="wrapper4" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/8cea7b15-a23e-41c4-9506-54478da67eec/initiator-shoes-4wMBsb.png);"></div>
        </div>
     ...
     <input type="hidden"  name="product" value="Nike Initiator"><p style="font-size: 24px; font-weight: 600;">Nike Initiator</p>
     ...
     <input type="hidden"name="price" value="4695"><p style="font-size: 24px; font-weight: 600;" name="price" value="">₱4,695</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 13";

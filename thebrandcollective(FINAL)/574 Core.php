...
<body>
  ...
  <main>
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://nb.scene7.com/is/image/NB/wl574evm_nb_05_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
          <div class="wrapper2" style="background-image: url(https://nb.scene7.com/is/image/NB/wl574evm_nb_08_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
          <div class="wrapper3" style="background-image: url(https://nb.scene7.com/is/image/NB/wl574evm_nb_06_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
          <div class="wrapper4" style="background-image: url(https://nb.scene7.com/is/image/NB/wl574evm_nb_04_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
        </div>

        <div class="grid2">
          <!-- form -->
          <form id="productForm" action="add_to_cart_process.php" method="post">
            <div class="flex">
              <input type="hidden" name="product" value="574 Core">
              <p style="font-size: 24px; font-weight: 600;">574 Core</p>
              <input type="hidden" name="price" value="9500">
              <p style="font-size: 24px; font-weight: 600;">₱9,500</p>
            </div>
            <p>Women's Shoe</p>
            ...
            <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 20";
              $result = mysqli_query($conn, $sql);

              if ($result && mysqli_num_rows($result) > 0) {
                  $row = mysqli_fetch_assoc($result);
                  $stock = $row['stocks'];
                  echo "<p> <strong>Stock Available:  </strong>" . htmlspecialchars($stock) . "</p>";
              } else {

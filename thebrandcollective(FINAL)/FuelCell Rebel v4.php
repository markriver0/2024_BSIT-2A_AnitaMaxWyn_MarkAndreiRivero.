...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://nb.scene7.com/is/image/NB/wfcxla4_nb_05_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper2" style="background-image: url(https://nb.scene7.com/is/image/NB/wfcxla4_nb_02_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper3" style="background-image: url(https://nb.scene7.com/is/image/NB/wfcxla4_nb_06_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
    
          <div class="wrapper4" style="background-image: url(https://nb.scene7.com/is/image/NB/wfcxla4_nb_04_i?$pdpflexf2$&qlt=80&fmt=webp&wid=440&hei=440);"></div>
        </div>
     ...
     <input type="hidden"  name="product" value="FuelCell Rebel v4"><p style="font-size: 24px; font-weight: 600;">FuelCell Rebel v4</p>

     <input type="hidden"name="price" value="10500"><p style="font-size: 24px; font-weight: 600;">₱10,500</p>
        </div>
        <p>Women's Shoe</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 19";

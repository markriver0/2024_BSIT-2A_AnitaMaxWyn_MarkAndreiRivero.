...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/d64f3d05-11ef-46e0-a719-bf57439a4e44/air-max-90-shoes-K0mczj.png);"></div>
    
          <div class="wrapper2" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/7d43f1f9-1a25-423d-8b5e-a1a58867ef72/air-max-90-shoes-K0mczj.png);"></div>
    
          <div class="wrapper3" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/ccfd21ea-e57c-4628-a100-54f7112f0a3f/air-max-90-shoes-K0mczj.png);"></div>
    
          <div class="wrapper4" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/cbbbaee2-b08c-4ece-b92a-1d64c1c1fb90/air-max-90-shoes-K0mczj.png);"></div>
        </div>
     ...
     <input type="hidden"  name="product" value="Nike Air Max 90"><p style="font-size: 24px; font-weight: 600;">Nike Air Max 90</p>

     <input type="hidden"name="price" value="4695"><p style="font-size: 24px; font-weight: 600;" name="price" value="">₱4,695</p>
        </div>
        <p>Women's Shoe</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 14";
        ...
        <div class="sizewrapper">
          ...
          <!-- <input type="hidden" name="amount" value="4695"> -->

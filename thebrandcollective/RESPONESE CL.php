...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/10b4c8f7b6484a128386fb7d4d4583ed_9366/Response_CL_Shoes_White_IG6226_42_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/4885c21f9a4f46e3b72c4d2c8158a48b_9366/Response_CL_Shoes_White_IG6226_04_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/8ec6439770f541b28f65a6794c358267_9366/Response_CL_Shoes_White_IG6226_05_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/aa0676fa012f43428fa28757dd6139f4_9366/Response_CL_Shoes_White_IG6226_41_detail.jpg);"></div>
        </div>
        ...
        <input type="hidden" name="product" value="RESPONESE CL" >  <p style="font-size: 24px; font-weight: 600;" >RESPONESE CL</p>
      ...
      <input type="hidden" name="price" value="9500" >    <p style="font-size: 24px; font-weight: 600;">₱9,500</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 12";

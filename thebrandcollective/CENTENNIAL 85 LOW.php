...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/a66d46e11b144de4a49794f6f722295c_9366/Centennial_85_Low_Shoes_Brown_IE3053_41_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/96aa7f67932046dcae9f45a9670f7796_9366/Centennial_85_Low_Shoes_Brown_IE3053_05_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/fcb8278d550a47b990a1b31de5d517e9_9366/Centennial_85_Low_Shoes_Brown_IE3053_04_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/d445b16361ee4a7786bc6d8ebea066b2_9366/Centennial_85_Low_Shoes_Brown_IE3053_42_detail.jpg);"></div>
        </div>
        ...
        <form action="add_to_cart_process.php" method="post">
          ...
          <div class="flex">
       <input type="hidden" name="product" value="CENTENNIAL 85 LOW"> <p style="font-size: 24px; font-weight: 600;">CENTENNIAL 85 LOW</p>

        <input type="hidden" name="price" value="9440">  <p style="font-size: 24px; font-weight: 600;">₱9,440</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 11";
        ...
        <div class="sizewrapper">
          ...
          <!-- <input type="hidden" name="amount" value="9440"> -->

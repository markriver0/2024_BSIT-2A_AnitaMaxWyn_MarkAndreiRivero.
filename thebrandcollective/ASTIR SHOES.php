...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/36de6e133f4d45ba9d13387df04c5566_9366/Astir_Shoes_White_IE9887_42_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/35a80fcbc87e4e7abbc98c8e257bb27f_9366/Astir_Shoes_White_IE9887_04_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/2be9a2ebddaf4e07b76d904d9896995e_9366/Astir_Shoes_White_IE9887_05_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7c07005374a24b7aaaaef00a4f6fa3c9_9366/Astir_Shoes_White_IE9887_41_detail.jpg);"></div>
        </div>
     ...
     <input type="hidden"  name="product" value="ASTIR SHOES"><p style="font-size: 24px; font-weight: 600;">ASTIR SHOES</p>

     <input type="hidden"name="price" value="5800"><p style="font-size: 24px; font-weight: 600;">₱5,800</p>
        </div>
        <p>Women's Shoe</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 21";
        ...
        <div class="sizewrapper">
          ...
          <div class="size4">
            <input type="radio" name="size" id="US8.5" value="US8.5" required> required

...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f08640a6-038c-4a7b-9b4e-56ef577c6ac1/air-max-plus-3-shoes-HtMt7V.png);"></div>
    
          <div class="wrapper2" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f47fe71f-8591-43dc-99c6-6c22372d2308/air-max-plus-3-shoes-HtMt7V.png);"></div>
    
          <div class="wrapper3" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/60982caa-e00d-4f6a-9e91-ebb41fcbf08c/air-max-plus-3-shoes-HtMt7V.png);"></div>
    
          <div class="wrapper4" style="background-image: url(https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/a92195bf-6503-4892-8c14-778f6fc8c650/air-max-plus-3-shoes-HtMt7V.png);"></div>
        </div>
        ...
        <form action="add_to_cart_process.php" method="post">
         ...
         <input type="hidden" name="product" value="Nike Air Max Plus 3"> <p style="font-size: 24px; font-weight: 600;">Nike Air Max Plus 3</p>

        <input type="hidden" name="price" value="5495">  <p style="font-size: 24px; font-weight: 600;">₱5,495</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 3";
        ...
        <div class="sizewrapper">
          ...
          <!-- <input type="hidden" name="amount" value="5495"> -->

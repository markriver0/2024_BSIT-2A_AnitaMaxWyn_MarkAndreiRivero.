...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/f18587849b714978962daace03e37722_9366/Bad_Bunny_Last_Campus_Shoes_Brown_ID2534_41_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/f2b8609b7455479abed58a2016145c8e_9366/Bad_Bunny_Last_Campus_Shoes_Brown_ID2534_05_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/dcbc921a9d844657a8d26515ef095f83_9366/Bad_Bunny_Last_Campus_Shoes_Brown_ID2534_04_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/271a519907b74f7db998cb7e63971723_9366/Bad_Bunny_Last_Campus_Shoes_Brown_ID2534_42_detail.jpg);"></div>
        </div>
        ...
        <form action="add_to_cart_process.php" method="post">
         ...
         <input type="hidden" name="product" value="Bad Bunny Last Campus"> <p style="font-size: 24px; font-weight: 600;">Bad Bunny Last Campus</p>

         <input type="hidden" name="price" value="9500"> <p style="font-size: 24px; font-weight: 600;">₱9,500</p>
        </div>
        <p>Mens Shoe</p>
        ...
        <div class="star-wrapper">
          <p>Rating: </p>
        <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="#E19191" d="m5.825 21l1.625-7.025L2 9.25l7.2-.625L12 2l2.8 6.625l7.2.625l-5.45 4.725L18.175 21L12 17.275z"/></svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="#E19191" d="m5.825 21l1.625-7.025L2 9.25l7.2-.625L12 2l2.8 6.625l7.2.625l-5.45 4.725L18.175 21L12 17.275z"/></svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="#E19191" d="m5.825 21l1.625-7.025L2 9.25l7.2-.625L12 2l2.8 6.625l7.2.625l-5.45 4.725L18.175 21L12 17.275z"/></svg>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 9";
        ...
        <div class="sizewrapper">
          ...
          <div class="size2">
            <input type="radio" name="size" id="US7.5" value="US7.7" required>
          ...
          <div class="size8">
            <input type="radio" name="size" id="US10.5" value="10.5" required>

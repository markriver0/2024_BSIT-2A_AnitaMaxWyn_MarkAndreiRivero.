...
<body>
  ...
  <main>
    ...
    <div class="body1">
      <div class="container">
        <div class="grid1">
          <div class="wrapper1" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/b814cf0bf5944a35a717c838092306e1_9366/Adiease_Shoes_Black_IE3156_42_detail.jpg);"></div>
    
          <div class="wrapper2" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/83cfb5b0df214fa484af07c7d8a9d460_9366/Adiease_Shoes_Black_IE3156_05_standard.jpg);"></div>
    
          <div class="wrapper3" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/979f62d299c04943a44ee35ec112c1c8_9366/Adiease_Shoes_Black_IE3156_04_standard.jpg);"></div>
    
          <div class="wrapper4" style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/741ad3398a5d472ebfd89ec97b4f59bf_9366/Adiease_Shoes_Black_IE3156_41_detail.jpg);"></div>
        </div>
        ...
        <form action="add_to_cart_process.php" method="post">
          ...
          <div class="flex">
       <input type="hidden" name="product" value="Adiese" >   <p style="font-size: 24px; font-weight: 600;">Adiese</p>

      <input type="hidden" name="price" value="4700">    <p style="font-size: 24px; font-weight: 600;">₱4,700</p>
        </div>
        <p>Mens Shoe</p>
        ...
        <div class="stocks">
              ...
              $sql = "SELECT stocks FROM products WHERE product_id = 10";
        ...
        <div class="sizewrapper">
          ...
          <div class="size5">
            <input type="radio" name="size" id="US9" value="US9" required> required
          ...
          <!-- <input type="hidden" name="amount" value="4700"> -->
